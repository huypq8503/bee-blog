                ...
                <div>
                    <div class="mat_khau">
                        ...
                        <form action="update-user.php" method="POST" class="pt-10 space-y-5">
                            ...
                            <input type="text" class="border border-black" placeholder='username' name='userName' value="<?= $users["userName"] ?>"><br>
                            <label for="">firstName</label>
                            <input type="text" class="border border-black" placeholder='name' name='firstName' value="<?= $users["firstName"] ?>"><br>
                            <label for="">lastName</label>
                            <input type="text" class="border border-black" placeholder='name' name='lastName' value="<?= $users["lastName"] ?>"><br>
