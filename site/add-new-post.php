...
<body>
    <form action="./controller/save-add-post.php" method="post" enctype="multipart/form-data">
        <div class="banner">
            <input type="file" name="thumbnail" id="banner-upload">
        ...
        <div class="blog">
            ...
            <textarea type="text" name="sub-title" class="title" placeholder="Blog sub title..."></textarea>
            ...
            <textarea name="editor_input" id="myTextarea"></textarea>
        </div>
        </div>

        <div class="blog-options">
            <button type="submit" name="add-post" class="btn dark publish-btn">publish</button>
        </div>
    </form>
</body>
