    ...
    <nav class="sidebar close">
        <header>
            <div class="image-text">
                <span class="image">
                    <a href="./admin.php"> <img src="../src/image/index/logo.png" alt=""></a>
                </span>
        ...
        <div class="menu-bar">
            <div class="menu">
                ...
                <ul class="menu-links">
                    <li class="nav-link">
                        <a href="../view/product-management.php" target="page">
                    ...
                    <li class="nav-link">
                        <a href="../view/category-management.php" target="page">
                    ...
                    <li class="nav-link">
                        <a href="../view/user-management.php" target="page">
                    ...
                    <li class="nav-link">
                        <a href="../view/comment-management.php" target="page">
                    ...
                    <li class="nav-link">
                        <a href="../view/statistical-show.php" target="page">
