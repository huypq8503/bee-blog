                ...
                <div>
                    ...
                    <div class="col-span-3">
                        <div class="main grid grid-cols-2 gab-5 mt-20 mx-5 justify-items-center text-center ">
                            <form action="update_img.php" method="post" enctype="multipart/form-data" class="up_img">
                                <input type="hidden" name="id" value=" <?php echo $users["id"] ?>" hidden> <br>
                                <input id="file" type="file" name="avatar" required> <br> <br>
                                <a href=""><button type="submit" name="btn">thay đổi</button> </a>

                            </form>

                            <div class="img">
                                <div style=""><?= $users["userName"] ?></div> <br>
                                <div style="width: 250px; text-align: center;"><img src="../public/image/<?php echo $users["avatar"] ?>" alt=""> </div>
                            </div>
                        </div>
                        <div>
                        </div>
